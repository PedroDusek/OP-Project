...
`npm run supabase <migrate|import|prices|contas|premium|aquecer|status|storage>`, que imprime o
...
npm run supabase <migrate|import|prices|contas|premium|aquecer|status|storage>
```
