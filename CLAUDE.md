...
`npm run supabase <migrate|import|prices|contas|premium|aquecer|limpar-contas|status|storage>`, que imprime o
...
npm run supabase <migrate|import|prices|contas|premium|aquecer|limpar-contas|status|storage>
```
