...
import type { SavedDeckSummary } from '@/server/application/decks'
import { DECK_TOTAL_COM_LIDER } from '@/server/application/decks'
 ...
 *
 * **"X de 51"** é quantas cartas a pessoa **já tem**, contando qualquer arte da
    ...
    <Panel className="flex items-center gap-3 p-3">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        ...
        <p className="text-xs text-text-subtle tabular-nums">
          {deck.owned} de {DECK_TOTAL_COM_LIDER} cartas você já tem
        </p>
      </div>
      {deck.incomplete ? (
